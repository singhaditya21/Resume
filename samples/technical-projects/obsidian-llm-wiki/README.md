# Obsidian LLM Wiki & Action Agent

- **Evidence status:** Code-derived architecture
- **Category:** Agentic AI & automation
- **Source package:** `Obsidian_LLM_Wiki.zip`

SharePoint-to-Markdown knowledge retrieval combined with governed, teachable browser automation for enterprise workflows.

The technical claims below are grounded in the supplied source archive.

## AI or automation role

NVIDIA-compatible answering, planning and skill selection operate beside deterministic fallback, human confirmation and trust progression.

## Technical stack

TypeScript · Next.js · React · Microsoft Graph · Playwright · PostgreSQL · Docker · Edge extension

## Skills demonstrated

- Enterprise knowledge ingestion
- Agent planning
- Teach-and-replay automation
- HITL
- Trust calibration
- Audit trails
...
SharePoint content → Document extraction → Markdown vault → Retrieval and context → Governed planner → Browser action evidence
...
- `packages/core/src/nim.ts`
- `packages/core/src/sharepoint.ts`
...
- Included sanitized source bytes: **64,879**
