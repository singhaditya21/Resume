...
No application, model, agent, data contract or deployment evidence is available; diagrams identify the evidence gap rather than inventing a system.
...
Initiative intent → Missing source → Problem definition → Architecture proposal → Implementation → Verification
