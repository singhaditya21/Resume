...
- **Source package:** `Paperclip AI.zip`

The supplied archive contains only an untouched project-template README; no implementation evidence was available.
...
No model, agent, retrieval, automation or application code is present. Architecture views are explicitly conceptual evidence-gap maps.
...
Project intent → Missing source → Evidence request → Architecture definition → Implementation → Validation
