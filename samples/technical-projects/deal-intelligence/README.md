...
- **Source package:** `Dealintelligence.zip`

This specific archive contains only a generic README; it does not include the deal-intelligence implementation found in a separate bundle.
...
No code or technical evidence can be attributed to this archive. The separate Agentic Harness package is assessed independently to avoid conflating sources.
...
Deal use-case intent → Missing source → Evidence contract → Pipeline design → Implementation → Evaluation
