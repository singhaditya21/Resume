# Agentic Harness & Deal Intelligence Lab

- **Evidence status:** Source-backed prototype
- **Category:** Agentic AI & automation
- **Source package:** `Agentic Harness.zip`

A multimodal conversation-intelligence and workflow lab with transcription, diarization, retrieval, deal scoring, visual context and n8n orchestration.

The technical claims below are grounded in the supplied source archive.

## AI or automation role

Speech, speaker, embedding, retrieval, vision and hosted/local language models refine deterministic MEDDICC and BANT scoring into an evidence-backed deal analysis.

## Technical stack

Python · Streamlit · n8n · Chroma · SentenceTransformers · Parakeet · pyannote · OpenCV
...
- RAG
- Deal methodology scoring
- Provider abstraction
- Workflow orchestration

## Primary system flow

Video audio and documents → ASR diarization and OCR → Transcript chunking → Vector retrieval → Deal scoring and LLM refinement → Dashboard and workflow actions
...
- `Deal Intelligence/dealintel/pipeline.py`
- `Deal Intelligence/dealintel/llm.py`
- `Deal Intelligence/dealintel/scoring.py`
- `Deal Intelligence/app/streamlit_app.py`
- `N8N Command Center/server.js`
...
- Included sanitized source bytes: **246,278**
